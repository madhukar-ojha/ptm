...
INSERT IGNORE INTO `department` (`id`, `name`, `description`, `enabled`, `deleted`, `createdBy`, `createdOn`, `updatedBy`, `updatedOn`) VALUES
...
INSERT IGNORE INTO `designation` (`id`, `role_id`, `role_name`, `department_id`, `department_name`, `designationName`, `hierarchy`, `description`, `enabled`, `deleted`, `createdBy`, `createdOn`, `updatedBy`, `updatedOn`) VALUES
...
) ENGINE=InnoDB AUTO_INCREMENT=136 DEFAULT CHARSET=latin1 COMMENT='It stores User personal details.';

-- Dumping data for table ptm.employee: ~11 rows (approximately)
/*!40000 ALTER TABLE `employee` DISABLE KEYS */;
INSERT IGNORE INTO `employee` (`id`, `firstName`, `middleName`, `lastName`, `nickName`, `displayName`, `fullName`, `gender`, `password`, `designation_id`, `dateOfBirth`, `fatherName`, `motherName`, `phone`, `mobile`, `email`, `address`, `pincode`, `india_state_id`, `enabled`, `deleted`, `createdBy`, `createdOn`, `updatedBy`, `updatedOn`, `insertTime`, `updatetime`) VALUES
	(100, 'Madhukar', '', 'Ojha', 'Gopal', 'Madhukar Ojha', 'Madhukar  Ojha', 'male', 'ptmpwd', 10, '2020-04-06', 'Madan Gopal Ojha', 'Bibha Ojha', '', '+91-9999889811', 'DSDFS@dfsd', '2nd floor HN-240, Sector 30 Faridabad', 110092, 43, 'true', 'false', 100, '2020-04-09 00:00:00', NULL, '2020-05-24 01:43:35', '0000-00-00 00:00:00', NULL),
	(101, 'Swapna', 'Avinash', 'Palkar', 'madhu', 'Swapna Palkar', 'Swapna Avinash Palkar', 'female', 'ptmpwd', 12, '1984-02-03', 'Avinash Palkar', 'Bibha Palkar', '', '+91-8469099764', 'zZX@xcxzcdasds@', 'Bharuch', 110092, 20, 'true', 'false', 100, '2020-04-09 00:00:00', NULL, '2020-05-24 19:58:59', '0000-00-00 00:00:00', NULL),
	(103, 'Atul', 'Kumar', 'Ojha', 'atul', 'Atul Ojha', 'Atul Kumar Ojha', 'male', 'Welcome@123', 17, '1980-07-01', 'dfgdf', 'dfgfdg', '54', '345353', 'gfdffdgfd@v', 'dgfdgd', 3555, 21, 'true', 'false', 101, '2020-05-02 00:00:00', NULL, '2020-05-16 00:00:00', '0000-00-00 00:00:00', NULL),
	(126, 'eeeeeeeeeeeeeeee', '', 'Ojha', 'babu', 'eeeeeeeeeeeeeeee Ojha', 'eeeeeeeeeeeeeeee  Ojha', 'male', 'Welcome@123', 22, '2014-10-14', 'Atul Kumar Ojha', 'Archana Ojha', '', '5685474125', 'aadi.ojha@gmail.com', 'Faridabad', 458712, 21, 'true', 'true', 101, '2020-05-08 00:00:00', NULL, '2020-05-25 12:42:45', '0000-00-00 00:00:00', NULL),
	(128, 'Atul', 'Kumar', 'Ojha', 'atul', 'Atul Ojha', 'Atul Kumar Ojha', 'male', 'ptmpwd', 29, '1980-07-01', 'Madan Gopal Ojha', 'Bibha Ojha', '', '9871725234', 'atul.ojha@gmail.com', 'Faridabad', 110093, 21, 'true', 'false', 101, '2020-05-11 00:00:00', NULL, '2020-05-25 12:43:00', '0000-00-00 00:00:00', NULL),
	(129, 'uuru', 'rturu', 'tuytu', 'tutyutu', 'uuru tuytu', 'uuru rturu tuytu', 'male', NULL, 31, '2020-05-11', 'reyer', 'rey', 'reye', 'ery', 'ey@fgg', 'fgdg', 774777, 25, 'true', 'false', 101, '2020-05-26 10:40:27', NULL, NULL, '0000-00-00 00:00:00', NULL),
	(130, 'fffffffff', 'ffffffffffffff', 'ffffffffffff', 'ffffffffffffffffff', 'fffffffff ffffffffffff', 'fffffffff ffffffffffffff ffffffffffff', 'male', NULL, 31, '2020-05-11', 'reyer', 'rey', 'reye', 'ery', 'ey@fgg', 'fgdg', 774777, 25, 'true', 'false', 101, '2020-05-26 10:44:19', NULL, NULL, '0000-00-00 00:00:00', NULL),
	(132, 'hdh', 'dfhfd', 'fdhdh', 'fhfdh', 'hdh fdhdh', 'hdh dfhfd fdhdh', 'male', NULL, 18, '2020-05-03', 'fdh', 'fdh', 'fhd', 'fdhfdh', 'fdhfd@fgdg', 'fdgdfg', 654566, 12, 'true', 'false', 100, '2020-05-03 00:00:00', NULL, NULL, '0000-00-00 00:00:00', NULL),
	(133, 'hdh', 'dfhfd', 'fdhdh', 'fhfdh', 'hdh fdhdh', 'hdh dfhfd fdhdh', 'male', NULL, 15, '2020-05-03', 'fdh', 'fdh', 'fhd', 'fdhfdh', 'fdhfd@fgdg', 'fdgdfg', 654566, 12, 'true', 'false', 100, '2020-05-03 00:00:00', NULL, NULL, '0000-00-00 00:00:00', NULL),
	(134, 'fwfw', 'fwe', 'erewr', 'ewrwer', 'fwfw erewr', 'fwfw fwe erewr', 'male', NULL, 19, '2020-05-03', 'ewr', 'wer', 'ewr', 'ewr', 'ewr@er', 'err', 324322, 19, 'true', 'false', 101, '2020-05-03 00:00:00', NULL, NULL, '0000-00-00 00:00:00', NULL),
	(135, 'etet', 'ett', 'ert', 'rete', 'etet ert', 'etet ett ert', 'male', NULL, 19, '2020-05-03', 'ert', 'ret', 'ret', 'ertt', 'ert@fdg', 'fdgg', 543455, 17, 'true', 'false', 101, '2020-05-03 00:00:00', NULL, NULL, '0000-00-00 00:00:00', NULL);
...
INSERT IGNORE INTO `india_state` (`id`, `name`, `capital`) VALUES
...
INSERT IGNORE INTO `menu` (`id`, `menuKey`, `menuName`, `menuUrl`, `menuType`, `serialNo`, `enabled`, `deleted`, `createdBy`, `createdOn`, `updatedBy`, `updatedOn`) VALUES
...
INSERT IGNORE INTO `role` (`id`, `name`, `description`, `enabled`, `deleted`, `createdBy`, `createdOn`, `updatedBy`, `updatedOn`) VALUES
...
INSERT IGNORE INTO `sub_menu` (`id`, `menu_id`, `actionKey`, `actionType`, `subMenuUrl`, `subMenuName`, `commandName`, `enabled`, `deleted`, `createdBy`, `createdOn`, `updatedBy`, `updatedOn`) VALUES
...
INSERT IGNORE INTO `sub_menu_dependency` (`id`, `subMenu_id`, `t_submenu_key`, `subMenu_dependency_id`, `t_subMenu_dependency_key`, `index`, `createdBy`, `createdOn`, `updatedBy`, `updatedOn`) VALUES
...
INSERT IGNORE INTO `user_role` (`id`, `designation_id`, `t_designation_name`, `submenu_command_id`, `t_menu_cmd_name`, `enabled`, `deleted`, `createdBy`, `createdOn`, `updatedBy`, `updatedOn`) VALUES
