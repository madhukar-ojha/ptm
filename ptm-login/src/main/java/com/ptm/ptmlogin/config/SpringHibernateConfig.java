package com.ptm.ptmlogin.config;


/*import static com.web.ptm.common.constant.StringConstants.APP_ENV_DEV;
import static com.web.ptm.common.constant.StringConstants.APP_ENV_PROD;
import static com.web.ptm.common.constant.StringConstants.APP_ENV_TEST;
import static com.web.ptm.common.constant.StringConstants.HIBERNATE_ENTITY_DIR;
import static com.web.ptm.common.constant.StringConstants.HIBERNATE_PROPERTIES_FILE;
*/
...
public class SpringHibernateConfig {
	...
	public LocalSessionFactoryBean sessionFactory() {
		...
		factoryBean.setPackagesToScan("com.ptm.ptmlogin");
	...
	private Properties getHibernateProperties() {
		...
		try {
			InputStream inputStream = getClass().getClassLoader().getResourceAsStream("hibernate/hibernate.properties");
	...
	private void setDataSourceEnv(LocalSessionFactoryBean factoryBean) {
		...
		} else if("dev".equalsIgnoreCase(envs[0])) {
